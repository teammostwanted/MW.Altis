...
if (isNil {IL_text_ON}) then { IL_text_ON = "<t color='#FF0000'>Ligar luz interior</t>"; };
if (isNil {IL_text_OFF}) then { IL_text_OFF = "<t color='#FF0000'>Desligar luz interior</t>"; };
if (isNil {IL_Green_Text}) then { IL_Green_Text = "<t color='#00FF00'>Mudar luz para verde</t>"; };
if (isNil {IL_Red_Text}) then { IL_Red_Text = "<t color='#FF0000'>Mudar luz para vermelho</t>"; };
