...
class CfgSpawnPoints {
    class Civilian {
        ...
        class Taxista {
            displayName = "Central de Taxis";
            spawnMarker = "taxista_spawn";
            icon = "\a3\ui_f\data\map\MapControl\bunker_ca.paa";
            licenses[] = { { "taxista", true } };
            level[] = { "", "", -1 };
        };
        class Doador {
            displayName = "Zona de Doador";
            spawnMarker = "doador_spawn";
            icon = "\a3\ui_f\data\map\MapControl\bunker_ca.paa";
            licenses[] = { { "", true } };
